    ...
    <nav className="nav">
        ...
        <div className="nav-column">
            <div className="btn-row">
                ...
                <Button handlePress={()=>{}} isPrimary={true}>Sign Up</Button>
            </div>
            <div className="burger">
                <svg onClick={(e)=>setIsOpen(!isOpen)} className={isOpen ? "burger-svg x" : "burger-svg"}>

                    <rect x="10" width="30" height="2" y="10"></rect>
                    <rect x="10" width="30" height="2" y="20"></rect>
                    <rect x="10" width="30" height="2" y="30"></rect>
                </svg>
            </div>
        </div>
        <MobileMenu showMobile={isOpen}/>
    </nav>
  )
}
